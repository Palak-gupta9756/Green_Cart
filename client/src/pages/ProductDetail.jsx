    ...
    return product && (
        ...
        {/* Related products */}
            <div className="flex flex-col mt-20 items-center">
                ...
                <button onClick={()=>{navigate('/products');scrollTo(0,0)}} className="mx-auto cursor-pointer px-12 py-2.5 my-16 bordered rounded text-primary hover:bg-primary/10  transition">See more</button>
            </div>
