...
const Cart = () => {
    const { products, currency, removeFromCart, cartItems, getCartCount, navigate, updateCartItem, getCartAmount, axios,user,setCartItems} = useAppContext();
        ...
        <div className="flex flex-col md:flex-row py-16 mt-16">
            <div className='flex-1 max-w-4xl'>
                ...
                <button onClick={() => {
                    ...
                    <img src={assets.arrow_right_icon_colored} alt="arrow" className="group-hove:translate-x-1 transition" />
                    Continue Shopping
                </button>
