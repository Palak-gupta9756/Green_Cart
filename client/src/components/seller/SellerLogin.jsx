...
const SellerLogin = () => {
    ...
    return !isSeller &&(
        <form onSubmit={onSubmitHandler} className='min-h-screen flex tem-center text-gray-600 text-sm'>
           ...
           <div className='w-full'>
            ...
            <button className='bg-primary text-white w-full py-2 cursor-pointer rounded-md'>Login</button>
           </div>
        </form>
    )
}
